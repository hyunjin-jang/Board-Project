    ...
    <div>
      <div className="profile-box">
        ...
        <div className="profile-middle">
          ...
          <h3>닉네임 : <input onChange={(e)=>{setNickName(e.target.value)}}></input></h3>
          <h3>생년월일 : {editBirth}</h3>
          <h3>이메일 : {editEmail}</h3>
          <h3>전화번호 : <input onChange={(e)=>{setPhone(e.target.value)}}></input></h3>
          <h3>주소 : <input onChange={(e)=>{setAddress(e.target.value)}}></input> </h3>
